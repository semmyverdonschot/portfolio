          ...
          <div className="md:col-span-12 space-y-12 md:space-y-14">
            ...
            <div className="flex flex-col md:flex-row md:items-start md:space-x-20 space-y-3 md:space-y-0">
              <p className="text-2xl md:text-4xl lg:text-5xl font-normal text-[var(--color-dark)] leading-tight flex-1 max-w-full md:max-w-4xl">
                I wear many hats in web development concept thinker, full-stack
                builder, and designer. I focus on building secure digital
                identities and interactions that leave a lasting impression.
              </p>
              <aside
              ...
              >
                <p>Originally from southern</p>
                <p>Netherlands, now studying</p>
                <p>at Fontys</p>
              </aside>
            </div>

            <div className="flex flex-row items-start space-x-6 md:space-x-8 pt-4 md:pt-8">
              <a
                href="#about"
              ...
              >
                <p>*Raised in southern Netherlands,</p>
